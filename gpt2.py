...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        #not really a 'bias', more of a mask , following OpenAI/HF naming though
...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type):
        ...
        # Print all keys in both state dictionaries
        '''
        print("Custom model state dict keys:")
        for key in sd.keys():
            print(key)
        print("\nHugging Face model state dict keys:")
        ...
        for k in sd_keys_hf:
            if any(k.endswith(w) for w in transposed):
                ...
                print("sd_hf[k].shape", k, sd_hf[k].shape, "sd[k].shape", sd[k].shape)
...
for i in range(num_return_sequeces):
